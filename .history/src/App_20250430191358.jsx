  ...
  async function generateAnswer(e) {
    ...
    try {
      const response = await axios.post(
        `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=AIzaSyAGcHZ25pUONsiURhlBHE8_ULrGzQh97sE`,
        {
          contents: [
            {
      ...
      setChatHistory((prev) => [
        ...prev,
        { type: "answer", content: "Error occurred. Try again!" },
      ]);
    }
    ...
    <div className="fixed inset-0 bg-gradient-to-r from-blue-50 to-blue-100">
      <div className="h-full max-w-4xl mx-auto flex flex-col p-3">
        <header className="text-center py-4">
          <h1 className="text-4xl font-bold text-blue-500">Gemini Chat</h1>
        </header>
